...
const nightColor = new Color("#ffffff", 1)
const linecolor = new Color("#eeeeee", 1)
const rainColor= new Color("#ffffff", 1)
...
if (imageBackground) {
  ...
  const path = files.joinPath(files.documentsDirectory(), "WeatherBG")
...
async function setupGradient() {
  ...
  var dawnGradientColor3 = new Color("62668B");
  ...
  let gradient = {
    dawn: {
      color() { 
        return [dawnGradientColor1, dawnGradientColor2, dawnGradientColor3] },
...
// drawText()
function drawTextC(text, fontSize, x, y, w, h, color = Color.white()){
  drawContext.setFont(Font.boldSystemFont(fontSize))
  drawContext.setTextColor(color)
